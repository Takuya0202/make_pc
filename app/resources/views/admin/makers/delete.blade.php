<x-layouts.admin title="削除確認">
    ...
    <div class="h-full w-full flex items-center justify-center">
        <div class="bg-white w-[60%] max-w-[600px] hadow-md text-center p-6 rounded-xl">
            <form action="{{route('admin.makers.destroy', ['maker_id' => $maker->id])}}" method="post" >
                @csrf
                @method('DELETE')
                <p class="text-center text-xl font-bold my-5">本当に<span class="mx-2 text-2xl text-center text-red-600">{{$maker->name}}</span>を削除しますか</p>
